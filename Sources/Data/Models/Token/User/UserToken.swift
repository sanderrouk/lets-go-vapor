...
public final class UserToken: SQLiteModel {
    /// Creates a new `UserToken` for a given user.
    public static func create(userID: User.ID) throws -> UserToken {
    ...
    public init(id: Int? = nil, string: String, userID: User.ID) {
        self.id = id
        self.string = string
...
extension UserToken {
    ...
    public var user: Parent<UserToken, User> {
